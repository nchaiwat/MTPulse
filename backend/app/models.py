...
class MonitoringSnapshot(Base):
    ...
    host_cpu_percent: Mapped[Decimal | None] = mapped_column(Numeric(6, 2))
    host_memory_used_percent: Mapped[Decimal | None] = mapped_column(Numeric(6, 2))
    host_memory_total_bytes: Mapped[int | None] = mapped_column(BigInteger)
    host_disk_used_percent: Mapped[Decimal | None] = mapped_column(Numeric(6, 2))
