...
export const MODERN_TRADES: Readonly<Record<ModernTradeCode, ModernTradeDefinition>> = {
  ...
  HP: {
    code: 'HP',
    name: 'HomePro',
    displayName: 'HomePro (HP)',
    navigationLabel: 'HomePro',
    sourceGroupCode: 'HP_MH',
    sourceOwnerCode: 'HP',
    inventoryMetrics: ['stockOh', 'stockValue'],
    activeCapabilities: hpMhActive,
    plannedCapabilities: ['correctiveImport'],
  },
  MH: {
    code: 'MH',
    name: 'MegaHome',
    displayName: 'MegaHome (MH)',
    navigationLabel: 'MegaHome',
    sourceGroupCode: 'HP_MH',
    sourceOwnerCode: 'HP',
    inventoryMetrics: ['stockOh', 'stockValue'],
    activeCapabilities: hpMhActive,
  ...
  HH: {
    code: 'HH',
    name: 'HomeHub',
    displayName: 'HomeHub (HH)',
    navigationLabel: 'HomeHub',
    sourceGroupCode: 'HH',
    sourceOwnerCode: 'HH',
    inventoryMetrics: ['stockOh', 'stockValue'],
  ...
  GH: {
    code: 'GH',
    name: 'Global House',
    displayName: 'Global House (GH)',
    navigationLabel: 'Global House',
    sourceGroupCode: 'GH',
    sourceOwnerCode: 'GH',
    inventoryMetrics: ['stockOh', 'stockValue'],
    activeCapabilities: complete,
  ...
  SCG: {
    ...
    displayName: 'Modern Trade SCG (SCG)',
    navigationLabel: 'SCG',
    sourceGroupCode: 'SCG',
    sourceOwnerCode: 'SCG',
    inventoryMetrics: [],
    activeCapabilities: [],
    plannedCapabilities: complete,
  },
  TA: {
    code: 'TA',
    name: 'Thai-Aust',
    displayName: 'Thai-Aust (TA)',
    navigationLabel: 'Thai-Aust',
    sourceGroupCode: 'TA',
    sourceOwnerCode: 'TA',
    inventoryMetrics: ['stockOh', 'stockValue'],
    activeCapabilities: complete,
...
export function isModernTradeCapabilityActive(code: string, capability: ModernTradeCapability): boolean {
